...
CREATE TABLE gtest35(a int, b int GENERATED ALWAYS AS (a) STORED NOT NULL, CONSTRAINT cc check (b > 0)) PARTITION BY RANGE (a);
...
CREATE TABLE gtest36(a int, b int GENERATED ALWAYS AS (a) STORED NOT NULL, CONSTRAINT cc check (b > 0));
...
ALTER TABLE gtest36_1 ALTER COLUMN b SET EXPRESSION AS (a + 1); -- ok
