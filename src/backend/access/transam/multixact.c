 ...
 */
void
multixactoffsetssyncfiletag(struct PgStreamingWrite *pgsw, InflightSyncEntry *entry)
{
 ...
 */
void
multixactmemberssyncfiletag(struct PgStreamingWrite *pgsw, InflightSyncEntry *entry)
{
