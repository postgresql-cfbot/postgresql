 ...
 * reused for future parallel queries.  For now it provides space for a shared
...
/*
 * Attach to a per-session DSM segment provided by a parallel leader.  This
 * causes the current worker to share the same record typmod registry.
 */
void
