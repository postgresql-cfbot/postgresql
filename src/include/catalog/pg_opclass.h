...
DATA(insert (	3580	oid_minmax_multi_ops	PGNSP PGUID 4151	26 f 26 ));
DATA(insert (	3580	oid_bloom_ops			PGNSP PGUID 5029	26 f 26 ));
DATA(insert (	3580	tid_minmax_ops			PGNSP PGUID 4069	27 t 27 ));
DATA(insert (	3580	tid_minmax_multi_ops	PGNSP PGUID 4152	27 f 27 ));
...
DATA(insert (	3580	time_minmax_multi_ops	PGNSP PGUID 4159  1083 f 1083 ));
...
DATA(insert (	3580	interval_minmax_multi_ops	PGNSP PGUID 4158  1186 f 1186 ));
...
DATA(insert (	3580	timetz_minmax_multi_ops	PGNSP PGUID 4157  1266 f 1266 ));
...
DATA(insert (	3580	uuid_minmax_multi_ops	PGNSP PGUID 4155  2950 f 2950 ));
...
DATA(insert (	3580	pg_lsn_minmax_multi_ops	PGNSP PGUID 4156  3220 f 3220 ));
