 ...
 *	  case-sensitive comparison; see also COMPLETE_WITH, below).
 * 4) A string constant.
...
#define COMPLETE_WITH_LIST_X(cs, list) \
do { \
...
#define COMPLETE_WITH_LIST(list) COMPLETE_WITH_LIST_X(false, (list))
#define COMPLETE_WITH_LIST_CS(list) COMPLETE_WITH_LIST_X(true, (list))
