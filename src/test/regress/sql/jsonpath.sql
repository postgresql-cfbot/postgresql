...
select '$.a.**.b'::jsonpath;
select 'pg $.a.**.b'::jsonpath;
select 'pg $.a.**{2}.b'::jsonpath;
select 'pg $.a.**{2 to 2}.b'::jsonpath;
select 'pg $.a.**{2 to 5}.b'::jsonpath;
select 'pg $.a.**{0 to 5}.b'::jsonpath;
select 'pg $.a.**{5 to last}.b'::jsonpath;
select 'pg $.a.**{last}.b'::jsonpath;
select 'pg $.a.**{last to 5}.b'::jsonpath;
select '$+1'::jsonpath;
select '$-1'::jsonpath;
select '$--+1'::jsonpath;
select '$.a/+-1'::jsonpath;
