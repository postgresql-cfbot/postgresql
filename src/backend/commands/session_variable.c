...
typedef struct SVariableData
{
	 ...
	 * the beginning of the session next transaction, and it's possible
	 * that this next transaction sees a different variable with the same oid.
	 * We therefore need an extra identifier to distinguish both cases. We
