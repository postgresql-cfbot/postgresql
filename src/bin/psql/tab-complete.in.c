...
/* ALTER */
	...
	/* ALTER TABLE ALTER [COLUMN] <foo> ADD GENERATED */
		...
		COMPLETE_WITH("ALWAYS", "BY DEFAULT", "USING CONSTRAINT");
	...
	/* ALTER TABLE ALTER [COLUMN] <foo> ADD GENERATED BY DEFAULT */
		...
		COMPLETE_WITH("AS IDENTITY");
	/* ALTER TABLE ALTER [COLUMN] <foo> ADD GENERATED USING CONSTRAINT */
	else if (Matches("ALTER", "TABLE", MatchAny, "ALTER", "COLUMN", MatchAny, "ADD", "GENERATED", "USING", "CONSTRAINT"))
	{
		set_completion_reference(prev8_wd);
	 ...
	 * ALTER TABLE ALTER [COLUMN] <foo> ADD GENERATED USING CONSTRAINT
	 */
	else if (Matches("ALTER", "TABLE", MatchAny, "ALTER", MatchAny, "ADD", "GENERATED", "USING", "CONSTRAINT"))
	{
		set_completion_reference(prev7_wd);
		COMPLETE_WITH_SCHEMA_QUERY(Query_for_check_constraint_of_table);
	}
	 ...
	 * constr_name
	 */
	else if (Matches("ALTER", "TABLE", MatchAny, "ALTER", "COLUMN", MatchAny, "ADD", "GENERATED", "USING", "CONSTRAINT", MatchAny))
		COMPLETE_WITH("STORED");
	else if (Matches("ALTER", "TABLE", MatchAny, "ALTER", MatchAny, "ADD", "GENERATED", "USING", "CONSTRAINT", MatchAny))
		COMPLETE_WITH("STORED");
