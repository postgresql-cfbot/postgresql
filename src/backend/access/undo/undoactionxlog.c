...
#define TPDPageSetLSN(a, b) (void)(b)
...
typedef struct { unsigned xid_epoch; TransactionId xid; UndoRecPtr urec_ptr; } TransInfo; typedef struct { TransInfo transinfo[4]; } ZHeapPageOpaqueData;  typedef ZHeapPageOpaqueData *ZHeapPageOpaque;
#define XLogReadTPDBuffer(...) (0)
#define ZheapInitPage(...) do{}while(0)
#define TPDPageSetTransactionSlotInfo(...) do{}while(0)
#define TPDPageSetOffsetMap(...) do{}while(0)
