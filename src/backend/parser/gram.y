...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	TIES TIME TIMESTAMP TO TRAILING TRANSACTION TRANSACTIONAL
...
CreateSchemaVarStmt:
			CREATE OptTemp OptImmutable VARIABLE qualified_name opt_as Typename opt_collate_clause OptNotNull OptSchemaVarDefExpr OnEOXActionOption
				{
			...
			| CREATE OptTemp OptImmutable VARIABLE IF_P NOT EXISTS qualified_name opt_as Typename opt_collate_clause OptNotNull OptSchemaVarDefExpr OnEOXActionOption
				{
					CreateSchemaVarStmt *n = makeNode(CreateSchemaVarStmt);
					$8->relpersistence = $2;
					n->is_immutable = $3;
