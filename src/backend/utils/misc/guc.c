	...
	},
	{
		{"ignore_invalid_pages", PGC_POSTMASTER, DEVELOPER_OPTIONS,
			...
			gettext_noop("Detection of WAL records having references to "
						 ...
						 "the system to ignore such WAL records (but still "
						 "report a warning), and continue recovery. "
						 "This behavior may cause crashes, data loss, "
						 "propagate or hide corruption, or other serious "
						 "problems. Only has an effect during recovery."),
			GUC_NOT_IN_SAMPLE
		},
