		...
		*attrname = NULL;
		...
		switch (list_length(names))
		{
			case 1:
				...
				varid = LookupVariable(NULL, strVal(field1), false, true);
				break;
			...
			case 2:
				...
				if (IsA(field2, String))
				{
					 ...
					 */
					varoid_without_attr = LookupVariable(a, b, false, true);
					varoid_with_attr = LookupVariable(NULL, a, true, true);
				}
				else
				{
					/*
			...
			case 3:
				...
				if (IsA(field3, String))
				{
					 ...
					 * "schema"."variable"."*".
					 */
					varoid_without_attr = LookupVariable(b, c, false, true);
					varoid_with_attr = LookupVariable(a, b, true, true);
				}
				else
				{
			...
			case 4:
				...
				*attrname = d;
				varid = LookupVariable(b, c, true, true);
				break;
