...
restart:
	...
	foreach(l, indexoidlist)
	{
		 ...
		 * we might not have here.  (Also, it's probably more sound to collect
		 * the bitmaps before any transformations that might eliminate
		 * columns, but the practical impact of this is limited.)
		 */
