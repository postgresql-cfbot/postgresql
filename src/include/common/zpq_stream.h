...
/*
 * Parse comma-separated list of compression algorithms. It can be either explicitly specified, or include all algorithms supported by client library.
 * Returns:
 * - true if the compression string is successfully parsed
 * - false otherwise
