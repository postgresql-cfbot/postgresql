...
/*
 * The maximum possible value of for a MemoryContextMethodID and the bitmask
 * for binary ANDing out unrelated bits in the 8-byte chunk header.  This must
 * be set to the maximum value that can be represented by
 * MEMORY_CONTEXT_METHODID_BITS bits.
 */
#define MEMORY_CONTEXT_METHODID_MASK UINT64CONST(7)
