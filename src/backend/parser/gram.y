...
CreateSchemaVarStmt:
			CREATE OptTemp VARIABLE qualified_name opt_as Typename opt_collate_clause OptNotNull OptSchemaVarDefExpr OnEOXActionOption
				{
			...
			| CREATE OptTemp VARIABLE IF_P NOT EXISTS qualified_name opt_as Typename opt_collate_clause OptNotNull OptSchemaVarDefExpr OnEOXActionOption
				{
					CreateSchemaVarStmt *n = makeNode(CreateSchemaVarStmt);
					$7->relpersistence = $2;
					n->variable = $7;
