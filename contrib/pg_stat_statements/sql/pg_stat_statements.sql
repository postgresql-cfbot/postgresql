...
-- wrapper function to reset existing stats returns void
CREATE FUNCTION pg_stat_statements_reset_wrapper() RETURNS void
as
$$
...
SELECT pg_stat_statements_reset_wrapper();
DROP FUNCTION pg_stat_statements_reset_wrapper();
SELECT pg_stat_statements_reset();
