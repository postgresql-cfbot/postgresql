...
DATA(insert OID = 6017 (  "=="	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_eq_jsonpath - - ));
DESCR("jsonpath == jsonpath");
DATA(insert OID = 6018 (  "!="	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_ne_jsonpath - - ));
DESCR("jsonpath != jsonpath");
DATA(insert OID = 6019 (  "<"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_lt_jsonpath - - ));
DESCR("jsonpath < jsonpath");
DATA(insert OID = 6020 (  "<="	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_le_jsonpath - - ));
DESCR("jsonpath <= jsonpath");
DATA(insert OID = 6021 (  ">"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_gt_jsonpath - - ));
DESCR("jsonpath > jsonpath");
DATA(insert OID = 6022 (  ">="	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_ge_jsonpath - - ));
DESCR("jsonpath >= jsonpath");
DATA(insert OID = 6023 (  "+"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_pl_jsonpath - - ));
DESCR("jsonpath + jsonpath");
DATA(insert OID = 6024 (  "-"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_mi_jsonpath - - ));
DESCR("jsonpath - jsonpath");
DATA(insert OID = 6025 (  "*"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_mul_jsonpath - - ));
DESCR("jsonpath * jsonpath");
DATA(insert OID = 6026 (  "/"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_div_jsonpath - - ));
DESCR("jsonpath / jsonpath");
DATA(insert OID = 6027 (  "%"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_mod_jsonpath - - ));
DESCR("jsonpath % jsonpath");

DATA(insert OID = 6029 (  "=="	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_eq_jsonb - - ));
DESCR("jsonpath == jsonb");
DATA(insert OID = 6030 (  "!="	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_ne_jsonb - - ));
DESCR("jsonpath != jsonb");
DATA(insert OID = 6031 (  "<"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_lt_jsonb - - ));
DESCR("jsonpath < jsonb");
DATA(insert OID = 6032 (  "<="	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_le_jsonb - - ));
DESCR("jsonpath <= jsonb");
DATA(insert OID = 6033 (  ">"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_gt_jsonb - - ));
DESCR("jsonpath > jsonb");
DATA(insert OID = 6034 (  ">="	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_ge_jsonb - - ));
DESCR("jsonpath >= jsonb");
DATA(insert OID = 6035 (  "+"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_pl_jsonb - - ));
DESCR("jsonpath + jsonb");
DATA(insert OID = 6036 (  "-"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_mi_jsonb - - ));
DESCR("jsonpath - jsonb");
DATA(insert OID = 6037 (  "*"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_mul_jsonb - - ));
DESCR("jsonpath * jsonb");
DATA(insert OID = 6038 (  "/"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_div_jsonb - - ));
DESCR("jsonpath / jsonb");
DATA(insert OID = 6039 (  "%"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_mod_jsonb - - ));
DESCR("jsonpath % jsonb");

DATA(insert OID = 6040 (  "->"	   PGNSP PGUID b f f 6050 25 6050 0 0 jsonpath_object_field - - ));
DESCR("jsonpath -> text");
DATA(insert OID = 6041 (  "->"	   PGNSP PGUID b f f 6050 23 6050 0 0 jsonpath_array_element - - ));
DESCR("jsonpath -> int");
DATA(insert OID = 6042 (  "?"	   PGNSP PGUID b f f 6050 6050 6050 0 0 jsonpath_filter - - ));
DESCR("jsonpath ? jsonpath");
DATA(insert OID = 6072 (  "@"	   PGNSP PGUID b f f 6050 3802 6050 0 0 jsonpath_bind_jsonb - - ));
DESCR("jsonpath @ jsonb");
