 ...
 */
bool
PathNameDeleteTemporaryFile(FileName fileName, bool error_on_failure)
{
 ...
 */
void
PathNameDeleteTemporaryDirRecursively(FileName dirname)
{
	/*
 ...
 */
File
PathNameCreateTemporaryFile(char *tempfilepath)
{
	File file;
