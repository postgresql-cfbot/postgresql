 ...
 */
static bool
heap_tuple_attr_equals(TupleDesc tupdesc, int attrnum, Datum value1,
					   Datum value2, bool isnull1, bool isnull2)
{
 ...
 * listed as interesting) of the old tuple is a member of check_external_cols
 * and is stored externally.
 *
