...
DATA(insert OID = 4150 (	3580	integer_minmax_multi_ops	PGNSP PGUID ));
...
DATA(insert OID = 4157 (	3580	timetz_minmax_multi_ops	PGNSP PGUID ));
...
DATA(insert OID = 4151 (	3580	oid_minmax_multi_ops	PGNSP PGUID ));
DATA(insert OID = 5029 (	3580	oid_bloom_ops			PGNSP PGUID ));
DATA(insert OID = 4069 (	3580	tid_minmax_ops			PGNSP PGUID ));
DATA(insert OID = 4152 (	3580	tid_minmax_multi_ops	PGNSP PGUID ));
...
DATA(insert OID = 4159 (	3580	time_minmax_multi_ops	PGNSP PGUID ));
DATA(insert OID = 5037 (	3580	time_bloom_ops			PGNSP PGUID ));
DATA(insert OID = 4078 (	3580	interval_minmax_ops		PGNSP PGUID ));
DATA(insert OID = 4158 (	3580	interval_minmax_multi_ops	PGNSP PGUID ));
...
DATA(insert OID = 4155 (	3580	uuid_minmax_multi_ops	PGNSP PGUID ));
DATA(insert OID = 5046 (	3580	uuid_bloom_ops			PGNSP PGUID ));
DATA(insert OID = 4103 (	3580	range_inclusion_ops		PGNSP PGUID ));
DATA(insert OID = 4082 (	3580	pg_lsn_minmax_ops		PGNSP PGUID ));
DATA(insert OID = 4156 (	3580	pg_lsn_minmax_multi_ops	PGNSP PGUID ));
