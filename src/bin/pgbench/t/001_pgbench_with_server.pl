...
pgbench('-t 100 -c 7 -M prepared -b se --debug',
  0,
...
# run custom scripts
pgbench('-t 100 -c 1 -j 2 -M prepared -n',
  0,
...
# throttling
pgbench('-t 100 -S --rate=100000 --latency-limit=1000000 -c 2 -n -r',
