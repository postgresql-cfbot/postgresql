		...
		switch (list_length(names))
		{
			...
			case 2:
				...
				else
				{
					...
					/*
					 * In this case, the field1 should be variable name.
					 * But direct unboxing of composite session variables
					 * is not supported now, and then we don't need to try
					 * lookup related variable.
					 *
